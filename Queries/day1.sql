...
--THIS IS LOOKING FOR PEOPLE WITH UNIQUE FIRST AND LAST NAME
...
-- information for the employee with SALARY 11000
SELECT FIRST_NAME, LAST_NAME, SALARY
FROM EMPLOYEES
WHERE SALARY = 11000;--3 ROWS
...
SELECT * FROM EMPLOYEES
WHERE SALARY >= 5000 AND SALARY <= 12000;--50 ROWS


--RANGE CHECKING IS MUCH SIMPLER IN SQL USING
--BETWEEN........ AND
-- IS SAME AS COLUMN_VALUE>=lowerLimit AND COLUMN_VALUE <= upperLimit
--ABOVE QUERY CAN BE MUCH SIMPLE AND MORE READABLE AS BELOW
SELECT * FROM EMPLOYEES
WHERE SALARY BETWEEN 5000 AND 12000;--50 ROWS
...
--more that 5000 and less than 12000
...
-- DISPLAY ALL THE FIRST_NAME THAT CONTAIN LETTER a IN EMPLOYEES TABLES
SELECT FIRST_NAME
FROM EMPLOYEES
WHERE FIRST_NAME LIKE '%a%'  ;  -- 16 ROWS
