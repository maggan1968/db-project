...
public class SimpleNavigation {
    public static void main(String[] args) throws SQLException {
        ...
        resultSet.next();// NOW WE ARE AT 2TH ROW
        System.out.println("rs.getString(\"REGION_ID\") = "
                + resultSet.getString("REGION_ID"));
        ...
        //now we now move to next row
        resultSet.next();// NOW WE ARE AT 3TH ROW
        System.out.println("rs.getString(\"REGION_ID\") = "
                + resultSet.getString("REGION_ID"));
        ...
        //now we now move to next row
        resultSet.next();// NOW WE ARE AT 4TH ROW
        System.out.println("rs.getString(\"REGION_ID\") = "
                + resultSet.getString("REGION_ID"));
...
//we are currently at last row and resultSet.next()will return false if called igain
        System.out.println("resultSet.next() = " + resultSet.next());//runs false because we don't have more rows
//now try to get the cell
    }
}
