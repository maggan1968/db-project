...
// ACT
    ...
    public void testSearchByPartialName(){
        ...
        // searched by name contains a and got 62 result on ui
        ...
        int actualResulFromDB = Integer.parseInt(DB_Util.getFirstRowFirstColumn());

        // assert
        assertEquals(actualResultFromUI, actualResulFromDB);
    }
}
